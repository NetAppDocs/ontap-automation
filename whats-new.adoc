...
The ONTAP 9.19.1 release includes several modest updates which continue to refine the ONTAP REST API.
...
SAN::
LUN map administration has been enhanced with an improved update capability.
