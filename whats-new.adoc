...
Security::
There are several major security enhancements introduced with the ONTAP 9.18.1 REST API. You can use the new cluster network endpoints to display and update the cluster network security configuration including certificate management. In addition, you can display and update the security configuration of the HA network for NVLog traffic. Autonomous Ransomware Protection (ARP) has been enhanced to enable display and update of the enablement feature.
