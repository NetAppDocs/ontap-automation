...
[NOTE]
The ONTAP REST API exposed to users of NetApp ASA r2 systems (ASA A1K, ASA A70, and ASA A90) is different than the REST API exposed for all other FAS, AFF, and ASA systems. See

https://docs.netapp.com/us-en/asa-r2/learn-more/rest-api-support.html[REST API support for ASA r2 systems^] for more information. 
