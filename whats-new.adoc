...
Cluster mediators::
You can ping the BlueXP cloud service using the ONTAP REST API. You can also modify the configuration of a specific mediator using the PATCH method with an existing endpoint.
