...
[NOTE]
Beginning with the 9.16.1 release, ONTAP is available in one of several different _personalities_. See link:../get-started/access_rest_api.html[ONTAP personalities] for more information.
