...
Security::
A new `whoami` feature has been added to retrieve the username, role, and permissions information for the logged in user. The web authentication (WebAuthn) capability has also been enhanced.
