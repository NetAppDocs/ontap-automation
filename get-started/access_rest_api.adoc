...
You can connect to the REST API using one of several types of ONTAP interfaces. The LIF you choose needs to be configured to support the HTTPS management protocol. Also, the firewall configuration in your network must allow the HTTPS traffic. The following interfaces are supported:
