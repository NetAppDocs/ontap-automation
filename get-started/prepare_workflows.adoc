...
If you use the workflow curl examples directly, you must update the variables they contain to use values appropriate for your environment. You can manually edit the examples or rely on the Bash shell to do the substitution for you as described below.
...
. Set the variable values included in the curl command. For example:
+
