...
The NetApp https://console.bluexp.netapp.com/automationCatalog/[BlueXP automation catalog^] is available through the BlueXP web user interface. The automation catalog provides access to solutions that can help you with the automated deployment and integration of ONTAP and other NetApp products. See the https://docs.netapp.com/us-en/netapp-automation/[Netapp automation^] site for documentation decsribing these automation solutions.
