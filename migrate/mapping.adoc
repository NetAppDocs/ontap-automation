...
[.lead]
The ONTAP REST API provides functionality that is equivalent to ONTAPI in most areas. NetApp provides documentation that describes the mapping from the ONTAPI API calls to the equivalent REST API calls.
