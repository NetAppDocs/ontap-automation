...
NetApp provides support for moving from the proprietary ONTAPI API to the newer and more robust ONTAP REST API.
...
There are several technologies available to help you to transform your ONTAP automation environment based on the REST API.
