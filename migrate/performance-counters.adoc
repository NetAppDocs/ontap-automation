...
=== Migrating ONTAPI objects to REST tables
...
You can use this REST API call to display the description and metadata for a specific table. The output includes the purpose of the table and what type of data each performance counter contains. The *disk* table is used in this example.
...
[source,curl]
----
curl --request GET --user admin:<PASSWORD> --insecure 'https://<ONTAP_IP_ADDRESS>/api/cluster/counter/tables/disk'
----
====
...
[source,curl]
----
curl --request GET --user admin:<PASSWORD> --insecure 'https://<ONTAP_IP_ADDRESS>/api/cluster/counter/tables/disk/rows'
----
====
...
=== Example 4: A single row or instance in a specific table
...
[source,curl]
----
curl --request GET --user admin:<PASSWORD> --insecure 'https://<ONTAP_IP_ADDRESS>/api/cluster/counter/tables/disk/rows/disk-01'
----
====
