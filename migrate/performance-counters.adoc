...
You can use this REST API call to view performance counter values for a specific counter manager instance in the table.

XXX: In this example, the performance counter information for one of the power supplies in the system is requested.
