...
summary: "The ONTAP Counter Manager maintains extensive information about the performance of each ONTAP system. It exports this data as a set of performance counters you can use to assess the performance of your ONTAP system and help meet your performance goals."
---

= Using performance counters with the ONTAP REST API
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
You can access the current https://docs.netapp.com/us-en/ontap-pcmap/[ONTAP performance counter mapping^] documentation online. There is also a version selector available to access previous versions of the documentation based on the ONTAP release.
