...
summary: "The ONTAP Counter Manager maintains extensive information about the performance of each ONTAP system. It exports this data as a set of _performance counters_ you can use to assess the performance of your ONTAP system and help meet your performance goals."
---
...
* https://docs.netapp.com/us-en/ontap-pcmap/[ONTAP 9.16.1 performance counter mapping^]
* https://docs.netapp.com/us-en/ontap-pcmap-9151/[ONTAP 9.15.1 performance counter mapping^]
