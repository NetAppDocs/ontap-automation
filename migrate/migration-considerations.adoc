...
NetApp is committed supporting our customers with their migration from ONTAPI to the ONTAP REST API. If you notice something is missing in the REST API, please let us know about the gap. You can submit your ideas at the https://forms.office.com/Pages/ResponsePage.aspx?id=oBEJS5uSFUeUS8A3RRZbOtlEKM3rNwBHjLH8dubcgOVURVM2UzIzTkQzSzdTU0pQRVFFRENZWlAxNi4u[ONTAPI to REST API^] page.
