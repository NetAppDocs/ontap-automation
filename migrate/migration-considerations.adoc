...
* ONTAP 9.8 through 9.19.1: v1, v2 and v3.  Some limitations apply; see the https://kb.netapp.com/on-prem/ontap/DP/SnapDiff/SnapDiff-KBs/FAQ_SnapDiff_Support_in_ONTAP[FAQ: SnapDiff Support in ONTAP^] for more details on SnapDiff support based on the ONTAP release.
