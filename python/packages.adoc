...
[.lead]
The Python client library is available for each ONTAP release beginning with 9.6. You should access the PyPI package and documentation based on the release of ONTAP you are using.
