...
== Packages and documentation for each ONTAP release
...
Each ONTAP release beginning with 9.6 has a PyPI package and associated documentation. Installation requirements are included with each package and specify versions of the supporting libraries such as python, requests, requests-toolbelt, and marshmallow.
