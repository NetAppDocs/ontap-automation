...
[NOTE]
While the NetApp Manageability SDK and OnCommand Workflow Automation continued to be supported, the ONTAP REST API is the preferred and strategic technology to use when automating your ONTAP systems. See link:../migrate/migration-considerations.html[Migrate from ONTAPI to the REST API] for more information.
...
* https://docs.netapp.com/us-en/workflow-automation/[OnCommand Workflow Automation documentation^]

// https://www.netapp.com/data-management/oncommand-workflow-automation-documentation/
