...
= SAN resources in the ONTAP REST API
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
A LUN map is an association between a LUN and an initiator group. This resource type was introduced with ONTAP 9.6 and updated with ONTAP 9.19.1.
