...
= Cluster resources in the ONTAP REST API
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
You can ping the NetApp Console cloud service. This resource type is new with ONTAP 9.17.1.

.Mediators

You can manage the mediator associated with MetroCluster, including adding or removing the mediator instance. This resource type is new with ONTAP 9.8 and updated with 9.17.1.
