...
You can retrieve information about all of the SVM pairs in the MetroCluster configuration. This resource type was introduced with ONTAP 9.11.1.
...
You can use these endpoints to retrieve the details about all the platform environment sensors. This resource type was introduced with ONTAP 9.11.1.
