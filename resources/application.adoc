...
= Application resources in the ONTAP REST API
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
You can use an application container to provision one or more storage objects. This resource type was introduced with ONTAP 9.17.1.
