...
You can use this set of API calls to manage the policies in effect for an IPSec deployment. This resource type is new with ONTAP 9.8. They have been updated with 9.19 to retrieve policies used for the cluster network.

.IPSec security associations

You can use this set of API calls to manage the security associations in effect for an IPSec deployment. This resource type is new with ONTAP 9.8. They have been updated with 9.19 to retrieve security associations used for the cluster network.
