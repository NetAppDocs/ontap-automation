...
You can access additional performance metrics data for a specific SVM instance. There are four lists are provided each with the  available most I/O activity for FlexVol and FlexGroup volumes. The lists include:
