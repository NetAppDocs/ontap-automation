...
+
https://netapp.io/2022/03/21/transitioning-from-ontapizapi-using-ontapi-usage-reporting-tool/[nTransitioning from ONTAPI(ZAPI) using ONTAPI Usage Reporting Tool^]
