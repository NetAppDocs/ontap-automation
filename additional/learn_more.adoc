...
// Article no longer there, link is redirected.
...
+
** https://netapp.io/2020/06/09/ontap-rest-api-python-client-library-pt1[Part 1^]
+
** https://netapp.io/2020/06/09/ontap-rest-api-python-client-library-pt2[Part 2^]
+
** https://netapp.io/2020/06/09/ontap-rest-api-python-client-library-pt3[Part 3^]
...
+
https://netapp.io/2022/03/21/transitioning-from-ontapizapi-using-ontapi-usage-reporting-tool/[Transitioning from ONTAPI(ZAPI) using ONTAPI Usage Reporting Tool^]
