...
You can issue an API call to update the contact information.
...
The identifier for the job object is returned. You should save the ID value to use it in the next step as variable $JOB_ID.
