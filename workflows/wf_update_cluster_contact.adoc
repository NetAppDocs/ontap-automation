...
You can issue an API call to update the contact information. Because the request runs asynchronously, you should confirm success of the associated job.
...
The identifier for the job object is returned. You should copy the ID to use it in the next step.
