...
You must have the certificate you want to install. You should also make sure any intermediate certificates are installed as needed for your environment.
