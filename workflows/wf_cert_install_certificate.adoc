...
You must have the certificate you want to install. You should also make sure the root CA certificate and any intermediate certificates are installed as needed.
