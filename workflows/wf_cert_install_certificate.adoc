...
You must have the certificate you want to install. XXX

If the certificate is not self-signed, you also need to make sure the root CA certificate and any intermediate CA certificates are install in ONTAP before using it.
