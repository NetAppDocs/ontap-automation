...
= Prepare to manage file security and audit policies using the ONTAP REST API
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
[NOTE]
For ONTAP releases prior to 9.9.1, you can automate the administration of the SACL and DACL permissions using the CLI passthrough feature. See link:../migrate/migration-considerations.html[Migrate from ONTAPI to the REST API] for more information.
