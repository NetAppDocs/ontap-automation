...
[TIP]
Each workflow can issue REST API calls as part of performing a task. You should make sure that your ONTAP release supports all the API calls in the workflows you plan to use. See link:../reference/api_reference.html[API reference] for more information.
