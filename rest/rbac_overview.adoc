...
The REST API was introduced with ONTAP 9.6. The REST roles were included with this release. Also, when you create a REST role a corresponding traditional role is also created.
