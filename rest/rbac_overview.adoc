...
The REST API was introduced with ONTAP 9.6. The REST roles were included with this release. Also, the REST API and CLI started using a shared security domain. When you create a REST role, a corresponding traditional role is also created.
